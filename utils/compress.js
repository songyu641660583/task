 ...
 */
export default function (file, quality) {
	var qualitys = 0.52
			...
			if ((file.size / 1024).toFixed(2) < 300) {
				...
				reader.onload = ({
					...
					image.onload = async () => {
						...
						if (1 * 1024 <= parseInt((file.size / 1024).toFixed(2)) && parseInt((
								file.size / 1024).toFixed(2)) <= 10 * 1024) {
							var maxWidth = 1600
							var maxHeight = 1600
						...
						if (10 * 1024 <= parseInt((file.size / 1024).toFixed(2)) && parseInt((
								file.size / 1024).toFixed(2)) <= 20 * 1024) {
							maxWidth = 1400
							maxHeight = 1400
							targetWidth = originWidth
							targetHeight = originHeight
